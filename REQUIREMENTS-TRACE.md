...
| "ลืมรหัสผ่าน?" sheet, no sign-up (the prototype notice and test-account panel were removed at the owner's request; accounts are shared privately) | `LoginForm.tsx` |
