...
// 3 ─ Objectives & scope
{
  ...
  bulletsText(s, ["ฟังก์ชันหลัก 3 ฟังก์ชัน + แดชบอร์ดส่งออก Excel/PDF", "ข้อมูลจริง 3 วิทยาเขต 157 อาคาร 965 ห้อง เลือกคณะก่อนอาคาร", "เข้าสู่ระบบแบบจำลอง CMU Account และสิทธิ์ตามบทบาท"], 7.1, 2.4, 5.4, 2.3, 15);
...
// 8 ─ Feedback loop
{
  ...
  const rows = [
    ...
    ["ข้อมูลอาคารไม่ตรงจริง", "157 อาคาร 965 ห้องจากผังของคณะต่าง ๆ · เลือกคณะก่อนอาคาร"],
